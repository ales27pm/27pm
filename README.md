...
Les cinq offres disposent de pages HTML autonomes sous `/services/agence-web/`, `/services/creation-sites-web/`, `/services/sites-catalogues-fabricants/`, `/services/applications-web-sur-mesure/` et `/services/automatisation-ia/`. Les études `/etudes/boulet/` et `/etudes/maisons-turner/` présentent les décisions de conception et les limites des démonstrations, sans les qualifier de mandats clients.
